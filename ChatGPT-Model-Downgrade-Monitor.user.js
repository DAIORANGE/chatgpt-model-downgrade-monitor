...
const Dashboard = {
  host:null,root:null,open:false,resizeObserver:null,activeTab:"current",powExpanded:false,openPins:new Map(),
    ...
    this.root.innerHTML=`<style>
      ...
      .models{display:grid;grid-template-columns:minmax(0,1fr) auto minmax(0,1fr);gap:10px;align-items:stretch;margin:12px 0;padding:14px 12px;border-radius:15px;background:color-mix(in srgb,var(--accent) 9%,var(--surface2));border:1px solid color-mix(in srgb,var(--accent) 24%,var(--border));box-shadow:inset 0 0 0 1px color-mix(in srgb,var(--accent) 6%,transparent),inset 0 1px 9px color-mix(in srgb,var(--accent) 5%,transparent)}.modelbox{min-width:0;display:flex;flex-direction:column;justify-content:center;align-items:center;text-align:center}.modellabel{display:flex;align-items:center;justify-content:center;gap:4px;color:var(--muted);font-size:13px;font-weight:600}.modelbox b{display:block;margin-top:5px;font-size:18px;font-weight:700;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.modelbox code{display:block;color:var(--muted);font-size:12px;margin-top:3px;max-width:100%;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.flow-mid{display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;min-width:64px}.arrow{text-align:center;color:var(--accent);font-size:24px;font-weight:800;line-height:1;filter:drop-shadow(0 0 7px color-mix(in srgb,var(--accent) 35%,transparent))}.arrow.tone-normal{color:var(--normal)}.arrow.tone-danger{color:var(--danger)}.arrow.tone-conflict{color:var(--conflict)}.arrow.tone-warn{color:var(--warn)}.resultcheck{font-size:13.5px;font-weight:800;text-align:center;line-height:1.25;max-width:96px;color:var(--muted)}.resultcheck.tone-normal{color:var(--normal)}.resultcheck.tone-danger{color:var(--danger)}.resultcheck.tone-conflict{color:var(--conflict)}.resultcheck.tone-warn{color:var(--warn)}
