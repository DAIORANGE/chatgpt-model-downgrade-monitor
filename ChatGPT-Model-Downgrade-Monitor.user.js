...
const I18N={"zh-CN":{"brandPrimary":"模型鉴定姬","brandSecondary":"ChatGPT Model Downgrade Monitor","tabCurrent":"当前","tabArchive":"档案","tabNetwork":"网络","tabSettings":"设置","btnClose":"关闭","btnCopy":"复制诊断","btnGitHub":"GitHub ↗","btnGitHubTitle":"打开 GitHub 项目主页","btnSave":"保存标签","btnSaved":"已保存","btnExpand":"展开","btnCollapse":"收起","btnPin":"固定","btnPinned":"已固定","btnResetPos":"重置悬浮窗位置","btnClear":"清空历史和 PoW","btnPreview":"试听","floatTitle":"模型鉴定姬","floatTitleTooltip":"打开模型鉴定姬","floatPowTooltip":"查看 PoW 分析","floatCollecting":"正在采集本轮证据…","floatWaiting":"等待鉴定","verdict_NORMAL":"模型一致","verdict_ROUTE_NOTICE":"模型字段发生变化","verdict_MODEL_MISMATCH":"请求与应答模型不一致","verdict_EVIDENCE_CONFLICT":"路由证据冲突","verdict_UNKNOWN":"信息未完整捕获","verdict_insufficient":"信息不足","hook_READY":"正常","hook_PARTIAL":"部分可用","hook_FAILED":"异常","hook_unknown":"未知","requestedModel":"调用模型","assistantModel":"应答模型","serverModel":"服务器路由","resolvedModel":"服务器确认模型","modelsMatch":"模型一致","modelMismatch":"模型不一致","routeConflict":"路由证据冲突","incompleteEvidence":"证据未完整","routeFieldChanged":"模型字段发生变化","statusUndetermined":"状态未确定","networkUnnamed":"未命名网络","rttEstimate":"浏览器 RTT 粗略估算","downlinkEstimate":"浏览器下行估算","currentTurn":"本轮鉴定","waitingResponse":"等待应答","archiveOverview":"总览","archiveRecords":"记录","archiveAnomaly":"异常监测","archiveModelsMatch":"模型一致","archiveReqNeqResp":"请求≠应答","archiveEvidenceConflict":"证据冲突","archiveNodePerf":"节点表现","archiveModelUsage":"模型使用比例","archiveNoData":"暂无数据","archiveEmpty":"暂无档案。","archiveOldRecord":"这条旧记录没有保存对话摘要","archiveNoReply":"尚未提取到回复摘要","networkCurrent":"当前网络","networkNodeLabel":"节点 / 网络名称（手动命名）","networkStats":"按网络标签统计","networkEmpty":"暂无网络统计。","powAnalysis":"PoW 分析","powSamples":"样本","powAvgWork":"平均估算工作量","powMedianWork":"中位估算工作量","powLatestRaw":"最新 raw 阈值","powInsufficient":"PoW 样本不足，暂时无法画估算工作量趋势。","powYAxis":"估算工作量（期望尝试次数）","powLegendNormal":"绿色 · 模型一致","powLegendMismatch":"红色 · 请求与应答不一致","powLegendConflict":"紫色 · 路由证据冲突","powLegendIncomplete":"黄色 · 证据未完整","powLegendUnlinked":"灰色 · 未关联模型记录","powTooltipRaw":"PoW raw","powTooltipWork":"估算工作量","powTooltipNetwork":"网络","powTooltipStatus":"状态","powTooltipEvidence":"证据完整度","powTooltipUnlinked":"未关联模型记录","powFooter":"Y 轴越高 = 按公开逆向算法估算，需要的尝试次数越多。点位悬停可看该轮模型状态；这是逆向估算，不是 OpenAI 官方“风控分”。","powCollapsedHint":"默认折叠。点 PoW ⓘ 可以看“为什么平台使用它、数字大小怎么读、为什么不能把它当 IP 质量分”。","settingsLanguage":"界面语言","settingsLanguageAuto":"自动（跟随浏览器）","settingsLanguageZhCN":"简体中文","settingsLanguageEn":"English","settingsLanguageHelp":"自动模式会根据浏览器语言选择中文或英文。切换后立即生效。","settingsAlert":"提醒方式","settingsAlertEnabled":"模型不一致或路由冲突时提醒我","settingsAlertDesc":"总开关：关闭后仍记录，但不主动打扰你","settingsToastEnabled":"页面弹窗提醒","settingsToastDesc":"出现模型不一致、路由冲突或服务器字段变化时，在页面顶部显示人话提示","settingsSoundEnabled":"播放提示音","settingsSoundDesc":"只在模型不一致或路由冲突时发声","settingsSoundType":"提示音","settingsVolume":"音量","settingsDisplay":"显示方式","settingsGhostWarning":"在异常回复下显示模型警告","settingsGhostWarningDesc":"如果这一轮请求与应答模型不一致，或服务器证据互相冲突，就在对应 ChatGPT 回复下面标出来","settingsPrivacy":"隐私与记录","settingsPersistChat":"记住每条记录对应的对话","settingsPersistChatDesc":"只保存少量 Prompt 与回复摘要，方便以后认出是哪一次对话；不会保存完整聊天","settingsAdvanced":"高级","settingsTitleFlash":"后台标签页闪烁","settingsTitleFlashDesc":"页面在后台时，如果出现模型不一致或路由冲突，用浏览器标签标题提醒你","settingsGhostMarkAll":"在每条回复下显示鉴定结果","settingsGhostMarkAllDesc":"默认关闭；开启后连正常回复也会显示模型标签","settingsFloatingAnim":"浮动监控条动画","settingsFloatingAnimDesc":"关闭后仍显示模型名、状态颜色与真实 PoW 波形，但停止脉冲沿线流动动画","settingsWsFallback":"WebSocket 备用捕获","settingsWsFallbackDesc":"只有 ChatGPT 改用 WebSocket 传输时才可能用到，平时不需要管","settingsPowRecord":"记录 PoW","settingsPowRecordDesc":"保存服务器返回的工作量证明难度，用于网络/风控趋势对比；它不是 IP 质量分","settingsFooter":"模型鉴定姬只观察网络证据，不修改请求、Header、Cookie、模型选择或 ChatGPT 的回答内容。","settingsAppearance":"外观","settingsTheme":"主题","settingsThemeHint":"主题会一起改变背景、卡片、用户/AI 气泡、状态色、图表和解释便签，不只是换一个主色。","settingsThemeSystem":"系统自动","conceptTooltip":"点开解释","concept_pow_title":"PoW · 工作量证明","concept_requested_title":"调用模型","concept_assistant_title":"应答模型","concept_server_title":"服务器路由","concept_resolved_title":"服务器确认模型","concept_conflict_title":"路由证据冲突","concept_completeness_title":"证据完整度","concept_rtt_title":"浏览器 RTT 粗略估算","concept_downlink_title":"浏览器下行估算","concept_status_title":"状态判定是怎么来的","ledgerTitle":"本轮模型证据","ledgerEmpty":"还没有正在进行的这一轮。发送一条消息后，这里会实时显示证据采集状态。","ledgerCore":"核心","ledgerServer":"服务器","ledgerNotCaptured":"未捕获","ledgerMissing":"未捕获：","ledgerWaiting":"正在等待响应证据","ledgerWhy":"为什么出现这个结论？","ledgerWhyBoth":"两者不同，因此标记：请求与应答模型不一致","ledgerWhyMatch":"两者一致，核心对比匹配","ledgerWhyConflict":"服务器侧证据与应答不一致，附加：路由证据冲突","ledgerFooter1":"核心对比：调用模型 ↔ 应答模型","ledgerFooter2":"服务器辅助证据：确认模型 ＋ 路由模型","ledgerCollecting":"采集中","userBubble":"你","userAsked":"你问","aiBubble":"AI","gptReplied":"ChatGPT 回答","codeReply":"代码回答","toastMismatch":"模型不一致 · 请求与应答模型不同","toastConflict":"路由证据冲突 · 服务器字段互相矛盾","toastNotice":"模型字段发生变化 · 服务器侧模型字段与调用模型不同","titleFlash":"⚠ 模型鉴定姬：模型证据异常","simpleRouteSummary_01":"调用 {call} → {answer} 完成应答","simpleRouteSummary_02":"最终由 {answer} 完成应答；调用模型未捕获","simpleRouteSummary_03":"调用 {call}；已观测服务器路由 {route}，最终应答标签尚未捕获","simpleRouteSummary_04":"已观测服务器路由 {route}；调用模型与最终应答标签尚未捕获","simpleRouteSummary_05":"调用 {call}；最终应答模型尚未捕获","simpleRouteSummary_06":"尚未捕获可用的模型路由信息","simpleRouteSummary_notCaptured":"未捕获","localTopicUnnamed":"未命名对话","ghostMismatch":"⚠ 请求与应答模型不一致 · 核心对比不同","ghostNormal":"✓ 模型一致","ghostFieldChange":"△ 模型字段发生变化","ghostConflict":"◇ 路由证据冲突","msgUncaptured":"未捕获","nwStatsRow":"应答 {n} 次 · 请求≠应答 {m} · 路由冲突 {c} · 平均 PoW {p}","nwRespCount":"应答","nwReqNeqResp":"请求≠应答","nwRouteConflict":"路由冲突","nwAvgPow":"平均 PoW"},"en":{"brandPrimary":"ChatGPT Model Downgrade Monitor","brandSecondary":"模型鉴定姬","tabCurrent":"Current","tabArchive":"Archive","tabNetwork":"Network","tabSettings":"Settings","btnClose":"Close","btnCopy":"Copy Diagnostics","btnGitHub":"GitHub ↗","btnGitHubTitle":"Open GitHub project page","btnSave":"Save Label","btnSaved":"Saved","btnExpand":"Expand","btnCollapse":"Collapse","btnPin":"Pin","btnPinned":"Pinned","btnResetPos":"Reset floating bar position","btnClear":"Clear history & PoW","btnPreview":"Preview","floatTitle":"ChatGPT Model Downgrade Monitor","floatTitleTooltip":"Open Model Downgrade Monitor","floatPowTooltip":"View PoW analysis","floatCollecting":"Collecting turn evidence…","floatWaiting":"Awaiting verdict","verdict_NORMAL":"Models match","verdict_ROUTE_NOTICE":"Model field changed","verdict_MODEL_MISMATCH":"Model mismatch","verdict_EVIDENCE_CONFLICT":"Routing evidence conflict","verdict_UNKNOWN":"Incomplete evidence","verdict_insufficient":"Insufficient evidence","hook_READY":"Ready","hook_PARTIAL":"Partial","hook_FAILED":"Failed","hook_unknown":"Unknown","requestedModel":"Requested model","assistantModel":"Assistant model","serverModel":"Server route","resolvedModel":"Resolved model","modelsMatch":"Models match","modelMismatch":"Model mismatch","routeConflict":"Routing evidence conflict","incompleteEvidence":"Incomplete evidence","routeFieldChanged":"Model field changed","statusUndetermined":"Status undetermined","networkUnnamed":"Unnamed network","rttEstimate":"Browser RTT estimate","downlinkEstimate":"Browser downlink estimate","currentTurn":"Current turn","waitingResponse":"Waiting for reply","archiveOverview":"Overview","archiveRecords":"Records","archiveAnomaly":"Anomaly monitoring","archiveModelsMatch":"Models match","archiveReqNeqResp":"Req ≠ Resp","archiveEvidenceConflict":"Evidence conflict","archiveNodePerf":"Node performance","archiveModelUsage":"Model usage ratio","archiveNoData":"No data","archiveEmpty":"Archive empty.","archiveOldRecord":"Chat summaries not saved for this old record","archiveNoReply":"Reply summary not yet extracted","networkCurrent":"Current network","networkNodeLabel":"Node / network name (manual label)","networkStats":"By network label","networkEmpty":"No network statistics.","powAnalysis":"PoW analysis","powSamples":"Samples","powAvgWork":"Avg estimated work","powMedianWork":"Median estimated work","powLatestRaw":"Latest raw threshold","powInsufficient":"Not enough PoW samples to draw an estimated work trend.","powYAxis":"Estimated work (expected attempts)","powLegendNormal":"Green · Models match","powLegendMismatch":"Red · Model mismatch","powLegendConflict":"Purple · Route evidence conflict","powLegendIncomplete":"Yellow · Incomplete evidence","powLegendUnlinked":"Gray · Unlinked model record","powTooltipRaw":"PoW raw","powTooltipWork":"Estimated work","powTooltipNetwork":"Network","powTooltipStatus":"Status","powTooltipEvidence":"Evidence completeness","powTooltipUnlinked":"Unlinked model record","powFooter":"Higher Y-axis = more expected attempts under the public reverse-engineered algorithm. Hover a dot to see its model state; this is a reverse-engineering estimate, not an official OpenAI risk score.","powCollapsedHint":"Collapsed by default. Click PoW ⓘ for details.","settingsLanguage":"Interface language","settingsLanguageAuto":"Auto (follow browser)","settingsLanguageZhCN":"简体中文","settingsLanguageEn":"English","settingsLanguageHelp":"Auto selects Chinese or English from your browser language. Changes apply immediately.","settingsAlert":"Alerts","settingsAlertEnabled":"Alert on model mismatch or route conflict","settingsAlertDesc":"Master switch: records silently when off, no interruptions","settingsToastEnabled":"Toast notification","settingsToastDesc":"Shows a notice at the top when a mismatch, conflict or field change occurs","settingsSoundEnabled":"Play alert sound","settingsSoundDesc":"Only sounds on model mismatch or route conflict","settingsSoundType":"Alert sound","settingsVolume":"Volume","settingsDisplay":"Display","settingsGhostWarning":"Show model warning below abnormal replies","settingsGhostWarningDesc":"When the requested and assistant model disagree or server evidence conflicts, mark it below the ChatGPT reply","settingsPrivacy":"Privacy & records","settingsPersistChat":"Remember chat summaries per record","settingsPersistChatDesc":"Saves a short prompt/reply digest so you can recognize past conversations; does not save the full chat","settingsAdvanced":"Advanced","settingsTitleFlash":"Tab title flash in background","settingsTitleFlashDesc":"When a mismatch or conflict occurs while the tab is in the background, flash the browser tab title","settingsGhostMarkAll":"Show verdict under every reply","settingsGhostMarkAllDesc":"Off by default; when on, even normal replies show the matched model label","settingsFloatingAnim":"Floating monitor animation","settingsFloatingAnimDesc":"When off, stops the pulse travel animation","settingsWsFallback":"WebSocket fallback capture","settingsWsFallbackDesc":"Only needed if ChatGPT switches to WebSocket transport","settingsPowRecord":"Record PoW","settingsPowRecordDesc":"Save proof-of-work difficulty for trend comparison; it is NOT an IP quality score","settingsFooter":"This monitor only observes network evidence. It does not modify requests, headers, cookies, model selection, or ChatGPT reply content.","settingsAppearance":"Appearance","settingsTheme":"Theme","settingsThemeHint":"The theme changes background, cards, user/AI bubbles, status colors, charts and pin windows together — not just one accent color.","settingsThemeSystem":"System auto","conceptTooltip":"Click to explain","concept_pow_title":"PoW · Proof of Work","concept_requested_title":"Requested model","concept_assistant_title":"Assistant model","concept_server_title":"Server route","concept_resolved_title":"Resolved model","concept_conflict_title":"Routing evidence conflict","concept_completeness_title":"Evidence completeness","concept_rtt_title":"Browser RTT estimate","concept_downlink_title":"Browser downlink estimate","concept_status_title":"How verdicts are determined","ledgerTitle":"Turn model evidence","ledgerEmpty":"No active turn. Send a message and evidence capture will appear here.","ledgerCore":"Core","ledgerServer":"Server","ledgerNotCaptured":"Not captured","ledgerMissing":"Not captured: ","ledgerWaiting":"Waiting for response evidence","ledgerWhy":"Why this conclusion?","ledgerWhyBoth":"The two differ, therefore: Model mismatch","ledgerWhyMatch":"The two match, core comparison consistent","ledgerWhyConflict":"Server-side evidence disagrees with the assistant, additionally: Route evidence conflict","ledgerFooter1":"Core comparison: Requested ↔ Assistant","ledgerFooter2":"Server corroborating evidence: Resolved + Route","ledgerCollecting":"Collecting","userBubble":"You","userAsked":"You asked","aiBubble":"AI","gptReplied":"ChatGPT replied","codeReply":"Code reply","toastMismatch":"Model mismatch · requested and assistant disagree","toastConflict":"Route evidence conflict · server fields contradict each other","toastNotice":"Model field changed · server-side field differs from requested model","titleFlash":"⚠ Model Downgrade Monitor: model evidence anomaly","simpleRouteSummary_01":"Requested {call} → answered by {answer}","simpleRouteSummary_02":"Answered by {answer}; requested model not captured","simpleRouteSummary_03":"Requested {call}; server route {route} observed, final assistant label not yet captured","simpleRouteSummary_04":"Server route {route} observed; requested model and final assistant label not yet captured","simpleRouteSummary_05":"Requested {call}; final assistant model not yet captured","simpleRouteSummary_06":"No usable model routing information captured yet","simpleRouteSummary_notCaptured":"Not captured","localTopicUnnamed":"Unnamed chat","ghostMismatch":"⚠ Model mismatch · core comparison differs","ghostNormal":"✓ Models match","ghostFieldChange":"△ Model field changed","ghostConflict":"◇ Route evidence conflict","msgUncaptured":"Not captured","nwStatsRow":"{n} replies · Req≠Resp {m} · Route conflict {c} · Avg PoW {p}","nwRespCount":"Replies","nwReqNeqResp":"Req≠Resp","nwRouteConflict":"Route conflict","nwAvgPow":"Avg PoW"}};function currentLanguage(){var l=null;try{var r=localStorage.getItem(CONFIG.STORAGE_SETTINGS_KEY);var p=r?JSON.parse(r):null;l=p&&typeof p.language==="string"?p.language:"auto"}catch(e){l="auto"}if(l==="zh-CN")return"zh-CN";if(l==="en")return"en";try{var n=(navigator.language||"").toLowerCase();if(/^zh/.test(n))return"zh-CN";var ls=navigator.languages||[];for(var i=0;i<ls.length;i++)if(/^zh/.test(ls[i].toLowerCase()))return"zh-CN"}catch(e){}return"en"};function t(key,vars){var d=I18N[currentLanguage()]||I18N.en;var tx=d[key];if(tx===undefined||tx===null){var z=I18N["zh-CN"][key];if(z!==undefined&&z!==null)return z;return key}if(vars)for(var vk in vars)if(Object.prototype.hasOwnProperty.call(vars,vk))tx=tx.split("{"+vk+"}").join(String(vars[vk]!=null?vars[vk]:""));return tx};function displayNetworkLabel(value){if(!value||value===""||value==="未命名网络"||value==="Unnamed network")return t("networkUnnamed");return String(value)};
...
function friendlyModelName(slug) {
  if (!slug) return t("msgUncaptured");
...
function simpleRouteSummary(entry) {
  if (!entry) return { call: null, answer: null, route: null, answerSource: null, text: t("simpleRouteSummary_notCaptured") };
...
function localTopic(text) {
  var topicText = normalizeChatText(text).replace(/```[\s\S]*?```/g, " [代码] ");
  if (!topicText) return t("localTopicUnnamed");
  topicText = topicText.replace(/^(请|麻烦|帮我|能不能|可以|我想|我要|你能不能|你可以)\s*/i, "");
  var first = (sentenceList(topicText)[0] || topicText).replace(/^[:：,，\s]+/, "");
  return clipText(first, 26) || t("localTopicUnnamed");
}
...
function getConcepts() { return Object.freeze({
  pow:{title:t("concept_pow_title"),lead:"服务器要求你的浏览器先完成一个计算挑战，再允许请求继续。",sections:[
...
function statusInfo(entry){
  if(!entry)return{title:t("verdict_insufficient"),tone:"unknown",basis:"发送一条消息后，模型鉴定姬会比较调用模型和最终应答模型。",metrics:[]};
...
const Dashboard = {
  ...
  renderCurrent(el){if(!el)return;const h=State.hookHealth(),last=State.lastRouteResult();el.innerHTML=`<div class="kicker">${last?t('currentTurn'):t('waitingResponse')} · 捕获器 ${zhHook(h.overall)}</div>${this.routeCard(last,false)}<div class="muted">主界面只保留“这轮对话 / 调用了什么 / 什么模型回答 / 是否一致 / 当前网络”。服务器字段与其他技术项放在“技术证据”里。</div>`},
  renderArchive(el){
